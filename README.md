...
- Fixes `cn -v` on Windows so it shows the version cleanly without verbose module reload noise
- Cleans up the “already current” output for `cn update` and `cn update check`
